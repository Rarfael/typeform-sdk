# Typeform SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TypeformSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TypeformSDK(...) and TypeformSDK.test(...) become
#      TypeformSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "typeform_sdk"
_SDK_CLASS = "TypeformSDK"
