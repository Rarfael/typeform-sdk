...
from typeform_sdk.core.control import TypeformControl
...
from typeform_sdk.core.helpers import get_ctx_prop, to_map
...
class TypeformContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, TypeformResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TypeformResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TypeformError(code, msg, self)
