...
describe("FormDirect", function()
  it("should direct-list-form", function()
    local setup = form_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-form", setup.live and "live" or "unit")
  ...
  it("should direct-load-form", function()
    local setup = form_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-form", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function form_direct_setup(mockres)
