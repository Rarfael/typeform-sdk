...
local FormEntity = {}
FormEntity.__index = FormEntity


function FormEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FormEntity)
  self._name = "form"
  self._client = client
...
function FormEntity:get_name()
  return self._name
end


function FormEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FormEntity.new(self._client, opts)
end
...
function FormEntity:mark_deleted()
  self._deleted = true
end


function FormEntity:deleted()
  return true == self._deleted
end


function FormEntity:data_set(args)
  if args ~= nil then
...
function FormEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FormEntity:match_set(args)
  if args ~= nil then
...
function FormEntity:stream(action, args, callopts)
...
---@param reqmatch FormLoadMatch
---@param ctrl? table
---@return Form
---@return string? err
function FormEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch FormListMatch
---@param ctrl? table
---@return Form[]
---@return string? err
function FormEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata FormCreateData
---@param ctrl? table
---@return Form
---@return string? err
function FormEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata FormUpdateData
---@param ctrl? table
---@return Form
---@return string? err
function FormEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch FormRemoveMatch
---@param ctrl? table
---@return Form
---@return string? err
function FormEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function FormEntity:_run_op(ctx, post_done)
  local utility = self._utility
