...
func registerSDKWords(r *eng.Registry, client *sdk.TypeformSDK) {
...
func runOp(client *sdk.TypeformSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
