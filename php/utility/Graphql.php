...
class TypeformGraphql
{
    ...
    // equivalent.
    public static function body(TypeformContext $ctx): mixed
    {
    ...
    public static function errors(TypeformContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
