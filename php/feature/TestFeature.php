...
// Typeform SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TypeformTestFeature extends TypeformBaseFeature
{
    ...
    public function init(TypeformContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TypeformContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TypeformContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TypeformContext $ctx, $op, $args): array
    {
