...
class TypeformTestRunner
{
    ...
    {
        $live = self::getenv('TYPEFORM_TEST_LIVE');
        $override = self::getenv('TYPEFORM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('TYPEFORM_TEST_EXPLAIN');
...
class_alias('TypeformTestRunner', 'Runner');
class_alias('TypeformHelpers', 'Helpers');
