...
// Typeform SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TypeformSDK::test)
...
{
    private const SDK_CLASS = 'TypeformSDK';
    ...
    private const SDK_BASE = 'typeform_sdk';
