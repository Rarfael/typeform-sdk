...
class FormEntity extends TypeformEntityBase<Form> {
  ...
  async load(this: any, reqmatch?: FormLoadMatch, ctrl?: Control): Promise<FormEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Form> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: FormListMatch, ctrl?: Control): Promise<FormEntity[]> {
  ...
  async create(this: any, reqdata?: FormCreateData, ctrl?: Control): Promise<FormEntity> {
  ...
  async update(this: any, reqdata?: FormUpdateData, ctrl?: Control): Promise<FormEntity> {
  ...
  async remove(
    this: any, reqmatch?: FormRemoveMatch, ctrl?: Control,
  ): Promise<FormEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<FormEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
