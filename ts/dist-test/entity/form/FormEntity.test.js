...
(0, node_test_1.describe)('FormEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('TYPEFORM_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.TypeformSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'form.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != form_ref01_data.id);
        // LIST
        const form_ref01_match = {};
        const form_ref01_list = (await form_ref01_ent.list(form_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(form_ref01_list, { id: form_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(form_ref01_resdata_up0.id === form_ref01_data_up0.id);
        (0, node_assert_1.default)(form_ref01_resdata_up0[form_ref01_markdef_up0.name] === form_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(form_ref01_data_dt0.id === form_ref01_data.id);
        // REMOVE
        const form_ref01_match_rm0 = { id: form_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(form_ref01_list_rt0, { id: form_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    let client = __1.TypeformSDK.test(options, extra);
    ...
    if (live) {
        client = new __1.TypeformSDK(merge([
            {
