...
(0, node_test_1.describe)('FormDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-form', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-form', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-form', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-form', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        const client = new __1.TypeformSDK({
            apikey: env.TYPEFORM_APIKEY,
        });
        let idmap = env['TYPEFORM_TEST_FORM_ENTID'];
...
//# sourceMappingURL=FormDirect.test.js.map