...
function envOverride(m) {
    if ('TRUE' === process.env.TYPEFORM_TEST_LIVE ||
        'TRUE' === process.env.TYPEFORM_TEST_OVERRIDE) {
    ...
    m.TYPEFORM_TEST_EXPLAIN = process.env.TYPEFORM_TEST_EXPLAIN || m.TYPEFORM_TEST_EXPLAIN;
    return m;
}
