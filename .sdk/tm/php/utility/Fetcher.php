...
// Typeform SDK utility: fetcher

class TypeformFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TypeformSDK/1.0)';
    ...
    public static function call(TypeformContext $ctx, string $fullurl, array $fetchdef): array
    {
