...
// Typeform SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TypeformMakeRequest
{
    public static function call(TypeformContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TypeformResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TypeformResponse($fetched);
        } else {
