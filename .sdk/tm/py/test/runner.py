...
class TypeformTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TypeformTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TypeformTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TypeformTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
