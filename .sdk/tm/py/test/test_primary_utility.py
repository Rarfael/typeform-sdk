# Typeform SDK primary utility test
...
from projectname_sdk import TypeformSDK
from projectname_sdk.core.spec import TypeformSpec
from projectname_sdk.core.result import TypeformResult
from projectname_sdk.core.response import TypeformResponse
from projectname_sdk.core.operation import TypeformOperation
from projectname_sdk.core.error import TypeformError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import TypeformBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = TypeformSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = TypeformSDK.test(None, None)
        ...
        class TestInitFeature(TypeformBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TypeformBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TypeformSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TypeformSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TypeformSDK.test(None, setup_opts)
