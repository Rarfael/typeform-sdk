...
type Args struct {
	Entity string         `json:"entity" jsonschema:"form"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TypeformSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "typeform_list",
		Description: "List records from Typeform. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "typeform_load",
		Description: "Load a single record from Typeform. " +
...
func runOp(client *sdk.TypeformSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TypeformSDK, name string) (sdk.TypeformEntity, error) {
	switch strings.ToLower(name) {
	case "form":
		return client.Form(nil), nil
