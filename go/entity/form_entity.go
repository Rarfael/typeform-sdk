...
func NewFormEntity(client *core.TypeformSDK, entopts map[string]any) *FormEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FormEntity) GetName() string { return e.name }
...
func (e *FormEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FormEntity) Deleted() bool {
	return e.deleted
}


func (e *FormEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFormEntity(e.client, opts)
}

func (e *FormEntity) Data(args ...any) any {
...
func (e *FormEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Form; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FormEntity) DataTyped(data ...Form) Form {
	if len(data) > 0 {
		return typedFrom[Form](e.Data(asMap(data[0])))
	}
	return typedFrom[Form](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Form (all fields
// optional at the wire level).
func (e *FormEntity) MatchTyped(match ...Form) Form {
	if len(match) > 0 {
		return typedFrom[Form](e.Match(asMap(match[0])))
	}
	return typedFrom[Form](e.Match())
}
...
func (e *FormEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FormEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FormLoadMatch and returns an Form. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FormEntity) LoadTyped(reqmatch FormLoadMatch, ctrl map[string]any) (Form, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Form{}, err
	}
	return typedFrom[Form](res), nil
}




func (e *FormEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FormListMatch and returns []Form. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FormEntity) ListTyped(reqmatch FormListMatch, ctrl map[string]any) ([]Form, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Form](res), nil
}




func (e *FormEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FormCreateData and returns an Form. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FormEntity) CreateTyped(reqdata FormCreateData, ctrl map[string]any) (Form, error) {
...
func (e *FormEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// FormUpdateData and returns an Form. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *FormEntity) UpdateTyped(reqdata FormUpdateData, ctrl map[string]any) (Form, error) {
...
func (e *FormEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// FormRemoveMatch and returns an Form. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FormEntity) RemoveTyped(reqmatch FormRemoveMatch, ctrl map[string]any) (Form, error) {
...
func (e *FormEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
